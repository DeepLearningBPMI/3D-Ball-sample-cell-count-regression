...
#replace last fully connected layer with global average pooling, drop out, 4 unit fully connected layer, softmax activation
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.fc1 = nn.Linear(512*block.expansion, neuro_hidden)
        self.act1 = nn.ReLU()
        self.dropout1 = nn.Dropout(dropout) 
        self.output = nn.Linear(neuro_hidden, num_output_classes)
...
def resnet10(D, W, H, neuro_hidden, dropout,channels = 3, **kwargs):
    """Constructs a ResNet-10 model.
    """
    model = ResNet(BasicBlock, [1, 1, 1, 1], D, W, H, neuro_hidden, dropout, channels = 3, **kwargs)
    return model
...
def resnet50(D, W, H, neuro_hidden, dropout,channels = 3,**kwargs):
    """Constructs a ResNet-50 model.
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], D, W, H, neuro_hidden, dropout,channels = 3,**kwargs)
    return model
