...
def run(dataset):
   ...
   model.load_state_dict(torch.load(r"E:\Model_3D_Cell_differenciation\Model\ViT_3D\model_vit_BAL.pth"))
...
def plot_patient_results(patient, predicted_labels, predicted_std):
    ...
    svg_save_path = os.path.join(output_folder, f'{patient}_ViT.svg')
    tif_save_path = os.path.join(output_folder, f'{patient}_ViT.tif')
    plt.tight_layout()
...
if __name__ == '__main__':
  ...
  csv_filename = 'patient_Vit_BAL.csv'
