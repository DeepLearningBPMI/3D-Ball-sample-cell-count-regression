...
def run(dataset):
    ...
    model.load_state_dict(torch.load(r"E:\Model_3D_Cell_differenciation\Model\ResNet_3D_50\model_ResNet_3D_50_Blood.pth"))
    model.eval()
...
if __name__ == '__main__':
  ...
  csv_filename = 'patient_ResNet_Blood.csv'
